 ...
 * ├──────┼──────┼──────┼──────┼──────┼──────┤                   ├──────┼──────┼──────┼──────┼──────┼──────┤
 * │LShift│   R  │ALT(S)│SFT(N)│CRL(T)│   B  │                   │  , < │CTL(A)│SFT(E)│ALT(I)│   H  │   J  │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┐     ┌──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │ LCTR │   X  │   C  │   L  │   D  │   G  │ RGui │     │  \ | │  - _ │   U  │   O  │   Y  │   K  │  : ; │
 * └──────┴──────┴──────┴────┬─┴────┬─┴────┬─┴────┬─┘     └─┬────┴─┬────┴─┬────┴─┬────┴──────┴──────┴──────┘
 ...
 */
  ...
  [_NEU] = LAYOUT(
     ...
     KC_TAB,  KC_W,    KC_F,    KC_M,    KC_P,    KC_V,                           KC_SLSH, KC_DOT,  KC_Q,    KC_QUOT, KC_Z,    KC_ENT,
     KC_LSFT, KC_R,    ALT_S,   SFT_N,   CRL_T,   KC_B,                           KC_COMM, CTL_A,   SFT_E,   ALT_I,   KC_H,    KC_J,
     KC_LCTL, KC_X,    KC_C,    KC_L,    KC_D,    KC_G,   KC_RGUI,       KC_BSLS, KC_MINS, KC_U,    KC_O,    KC_Y,    KC_K,    KC_SCLN,
 ...
 * ├──────┼──────┼──────┼──────┼──────┼──────┤                   ├──────┼──────┼──────┼──────┼──────┼──────┤
 * │LShift│   A  │ALT(S)│SFT(D)│CTL(F)│   G  │                   │   H  │CTL(J)│SFT(K)│ALT(L)│  ' " │  - _ │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┐     ┌──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 ...
 */
  ...
  [_QWERTY] = LAYOUT(
     ...
     KC_LSFT, KC_A,    ALT_S,   SFT_D,   CTL_F,   KC_G,                           KC_H,    CTL_J,   SFT_K,   ALT_L,   KC_QUOT, KC_MINS,
 ...
 */
  ...
  [_ADJUST] = LAYOUT(
     ...
     _______, _______, _______, _______, _______, DF(_GAMES),                         DF(_NEU), _______, _______, _______, _______, _______,
     _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
                                    _______, _______, _______,                   _______, _______, _______
  )
    ...
    if (get_highest_layer(layer_state) >= 0) {
        ...
        switch(layer) {
			...
			case _GAMES:
                ...
                break;
			case _QWERTY:
				hsv = (hsv_t){170, 255, 255}; // blue
                break;
			case _NEU:
				hsv = (hsv_t){25, 232, 145}; // gold
                break;
            default:
				break;
        }
